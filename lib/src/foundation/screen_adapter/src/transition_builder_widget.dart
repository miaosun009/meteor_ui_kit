...
class TransitionBuilderWidget extends StatefulWidget {
  ...
  const TransitionBuilderWidget({Key? key, required this.builder, required this.child, required this.didChangeMetricsCallBack}) : super(key: key);
...
class _TransitionBuilderWidgetState extends State<TransitionBuilderWidget> with WidgetsBindingObserver {
  @override
  void initState() {
    super.initState();
