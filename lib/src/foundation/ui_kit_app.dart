...
/// [GridPaper].
///
/// [UIKitApp] configures its [WidgetsApp.textStyle] with an ugly red/yellow
...
///
/// The [UIKitApp] configures the top-level [Navigator] to search for routes
...
///
/// {@tool snippet}
/// This example shows how to create a [UIKitApp] that disables the "debug"
/// banner with a [home] route that will be displayed when the app is launched.
///
/// ![The UIKitApp displays a Scaffold ](https://flutter.github.io/assets-for-api-docs/assets/material/basic_material_app.png)
///
/// ```dart
/// UIKitApp(
///   home: Scaffold(
...
///
/// {@tool snippet}
/// This example shows how to create a [UIKitApp] that uses the [routes]
...
///
/// {@tool snippet}
/// This example shows how to create a [UIKitApp] that defines a [theme] that
/// will be used for material widgets in the app.
///
/// ![The UIKitApp displays a Scaffold with a dark background and a blue / grey AppBar at the top](https://flutter.github.io/assets-for-api-docs/assets/material/theme_material_app.png)
///
/// ```dart
/// UIKitApp(
///   theme: ThemeData(
...
///   home: Scaffold(
///     appBar: AppBar(
///       title: const Text('UIKitApp Theme'),
///     ),
///   ),
/// )
/// ```
...
class UIKitApp extends StatefulWidget {
  ...
  /// Creates a [UIKitApp] that uses the [Router] instead of a [Navigator].
  const UIKitApp.router({
    Key? key,
    this.scaffoldMessengerKey,
  ...
  /// ```
  ///
  /// Constructing a [UIKitApp] with a `FooLocalizationsDelegate` overrides
...
/// Describes how [Scrollable] widgets behave for [UIKitApp]s.
///
...
class _UIKitAppState extends State<UIKitApp> {
  ...
  void initState() {
    super.initState();
    _heroController = UIKitApp.createMaterialHeroController();
  }
